...
public struct Styles {
    public static let lineChartStyleOne = ChartStyle(
            ...
            backgroundGradientColor: GradientColor(start: Color("Blue").opacity(0.21), end: Color("Blue").opacity(0.00)),
            indicatorDotColor: Color("Blue"),
            textColor: Color.black,
            legendTextColor: Color.gray,
            fontName: "EuclidSquare-Medium",
...
public class ChartStyle {
    ...
    public var lineGradientColor: GradientColor
    public var backgroundGradientColor: GradientColor
    public var indicatorDotColor: Color
    ...
    public init(backgroundColor: Color, accentColor: Color, secondGradientColor: Color, backgroundGradientColor: GradientColor, indicatorDotColor: Color, textColor: Color, legendTextColor: Color, fontName: String, dropShadowColor: Color) {
        self.backgroundColor = backgroundColor
        self.accentColor = accentColor
        self.lineGradientColor = GradientColor(start: accentColor, end: secondGradientColor)
        self.backgroundGradientColor = backgroundGradientColor
        self.indicatorDotColor = indicatorDotColor
    ...
    public init(backgroundColor: Color, accentColor: Color, gradientColor: GradientColor, backgroundGradientColor: GradientColor, indicatorDotColor: Color, textColor: Color, legendTextColor: Color, fontName: String, dropShadowColor: Color) {
        self.backgroundColor = backgroundColor
        self.accentColor = accentColor
        self.lineGradientColor = gradientColor
        self.backgroundGradientColor = backgroundGradientColor
        self.indicatorDotColor = indicatorDotColor
        self.textColor = textColor
        self.legendTextColor = legendTextColor
    ...
    public init(formSize: CGSize) {
        ...
        self.lineGradientColor = GradientColors.orange
        self.backgroundGradientColor = GradientColor(start: Color("Blue").opacity(0.21), end: Color("Blue").opacity(0.00))
        self.indicatorDotColor = Color("Blue")
        self.legendTextColor = Color.gray
        self.textColor = Color.black
        self.fontName = "EuclidSquare-Medium"
